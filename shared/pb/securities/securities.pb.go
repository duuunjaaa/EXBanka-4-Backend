...
type ListingSummary struct {
	...
	OptionType     string  `protobuf:"bytes,14,opt,name=option_type,json=optionType,proto3" json:"option_type,omitempty"` // "CALL" or "PUT"
...
func (x *ListingSummary) GetOptionType() string {
	if x != nil {
		return x.OptionType
	}
	return ""
...
func (x *ListingSummary) GetStrikePrice() float64 {
	if x != nil {
...
func (x *ListingSummary) GetSettlementDate() string {
	if x != nil {
...
func (x *ListingSummary) GetOpenInterest() int64 {
	if x != nil {
...
const file_securities_proto_rawDesc = "" +
	...
	"\rnominal_value\x18\r \x01(\x01R\fnominalValue\x12\x1f\n" +
	"\voption_type\x18\x0e \x01(\tR\n" +
	"optionType\x12!\n" +
