...
const file_employee_proto_rawDesc = "" +
	...
	"\x18ActivateEmployeeResponse2\x8b\x05\n" +
	...
	"\x10ActivateEmployee\x12!.employee.ActivateEmployeeRequest\x1a\".employee.ActivateEmployeeResponseB/Z-github.com/exbanka/backend/shared/pb/employeeb\x06proto3"
...
var file_employee_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
...
var file_employee_proto_depIdxs = []int32{
	...
	2,  // 12: employee.EmployeeService.GetAllEmployees:output_type -> employee.GetAllEmployeesResponse
	4,  // 13: employee.EmployeeService.SearchEmployees:output_type -> employee.SearchEmployeesResponse
	6,  // 14: employee.EmployeeService.GetEmployeeCredentials:output_type -> employee.GetEmployeeCredentialsResponse
	8,  // 15: employee.EmployeeService.CreateEmployee:output_type -> employee.CreateEmployeeResponse
	10, // 16: employee.EmployeeService.GetEmployeeById:output_type -> employee.GetEmployeeByIdResponse
	12, // 17: employee.EmployeeService.UpdateEmployee:output_type -> employee.UpdateEmployeeResponse
	14, // 18: employee.EmployeeService.ActivateEmployee:output_type -> employee.ActivateEmployeeResponse
